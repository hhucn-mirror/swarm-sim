...
def process_event_queue__(sim):
    while not len(event_queue) == 0:
        ...
        if event_type == EventType.MessageSent:
            ...
            # color receiver
            net_event.receiver.set_color(Colors.green.value)
            ...
            # color receiver
            net_event.receiver.set_color(Colors.yellow.value)
            ...
            # color receiver
            net_event.receiver.set_color(Colors.orange.value)
            ...
            # color receiver
            net_event.receiver.set_color(Colors.red.value)
