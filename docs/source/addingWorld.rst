...
The same thing you can do it with creating markers and tiles. E.g creating two particles, tiles, and markers.
You have to create a python file e.g. two_particles_tiles_markers.py in robtotsOnTiles/sims/ and insert the  following code:
