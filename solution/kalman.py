...
def find_next_free_location(particle):
    ...
    possible_directions = []
    # (particle.nh_dist_list[direction].dist != particle.p_max.dist - 1 or particle.own_dist !yy= particle.nh_dist_list[direction].dist))
    for direction in reversed(direction_list):
        if (particle.nh_dist_list[direction].dist < particle.p_max.dist or particle.nh_dist_list[
            ...
            possible_directions.append((direction, particle.nh_dist_list[direction].dist))
