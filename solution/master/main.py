...
import solution.master.distance_calculation as distance_calc_mod
import solution.master.read_write as read_write_mod
import solution.master.p_max_calculation as p_max_calc_mod
...
def goal_reached(sim):
    ...
    print(min_fl_distance, max_particle_distance)
