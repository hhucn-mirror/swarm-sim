...
def solution(sim):
    ...
    if sim.get_actual_round() == 1:
        ...
        generate_random_messages(particles, len(particles)*5)
        ...
        for particle in particles:
            ...
            r_params = lib.routing.RoutingParameters(lib.routing.Algorithm.Epidemic_MANeT, scan_radius, manet_role=p_role,
                                                     manet_group=m_group)
